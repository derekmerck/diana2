...
@click.argument("items", type=click.STRING, callback=validate_array)
@click.option("-m", "--metakeys", type=click.STRING, callback=validate_array, default=None,
...
@click.pass_context
def cli(ctx, source: Orthanc, items, metakeys, fkey, kwargs, binary):
