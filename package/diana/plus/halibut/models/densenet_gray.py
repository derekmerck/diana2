...
def DenseNet(blocks,
    ...
    if weights == 'imagenet':
        if include_top:
            ...
            if channels == "gray":
                if blocks == [6, 12, 24, 16]:
                    weights_path = "/users/ipan/grayscale-models/weights/densenet121_gray.h5"
                elif blocks == [6, 12, 32, 32]:
                    weights_path = "/users/ipan/grayscale-models/weights/densenet169_gray.h5"
                elif blocks == [6, 12, 48, 32]:
                    weights_path = "/users/ipan/grayscale-models/weights/densenet201_gray.h5"
